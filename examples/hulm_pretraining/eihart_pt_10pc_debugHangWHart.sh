...
/home/nisoni/miniconda3/envs/hulm/bin/python -O /home/nisoni/eihart/EIHaRT/run_hulm_hart.py \
    ...
    --do_eval \
    --do_predict \
    --output_dir /home/nisoni/eihart/EIHaRT/output/debug_evalHangwHaRT_eihdata \
    --num_train_epochs 1 \
