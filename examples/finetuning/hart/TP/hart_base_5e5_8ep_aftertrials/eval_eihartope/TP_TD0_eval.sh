...
python -O /home/nisoni/eihart/EIHaRT/run_ft_eihart.py \
    --model_name_or_path /chronos_data/nisoni/eihartOPE/TP_afterTrials/TP_TD0_32bs_30ep_100bls_bestHP \
    --task_type document \
    --num_labels 5 \
    --do_predict \
    --per_device_eval_batch_size 32 \
    --block_size 100 \
    --output_dir /chronos_data/nisoni/EIHaRT_Downstream_final/TP_eval_eihart_ope/TD0 \
    --add_history \
