...
python -O /home/nisoni/eihart/EIHaRT/run_ft_eihart_lastplusstates.py \
    ...
    --block_size 100 \
    --max_train_blocks 8 \
    --output_dir /chronos_data/nisoni/eihart_lastplusstates/TP_test/TP_TD0_32bs_30ep_100bls_bestHP \
    --add_history \
