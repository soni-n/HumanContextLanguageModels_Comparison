...
python -O /home/nisoni/eihart/EIHaRT/run_ft_eihart.py \
    --model_name_or_path /chronos_data/nisoni/EIHaRT_Downstream_final/TP_5e5_8ep_aftertrials/TP_TD_Age_32bs_30ep_100bls_bestHP \
    --task_type document \
    --num_labels 2 \
    --do_predict \
    --per_device_eval_batch_size 32 \
    --block_size 100 \
    --output_dir /chronos_data/nisoni/EIHaRT_Downstream_final/TP_eval/TP_TD_Age \
    --add_history \
