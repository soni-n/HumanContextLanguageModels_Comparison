...
from data.mtl_eihart_data_collator import DataCollatorWithPaddingForSeqCls
...
def main():
    ...
    # Load dataset
    # dataset = load_dataset('/home/nisoni/eihart/EIHaRT/data/trustpilot.py', name='age.united_states.0.0.category', cache_dir="./reload")
    # TODO: remove hardcoding for dataset directory!!
    ...
    def encode_batch(batch):
        ...
        return tokenizer(batch["review"], max_length=block_size, truncation=True)#, padding=padding)
    ...
    ## TODO: added max_length and padding to max_length strategy here: change if needed
    data_collator = DataCollatorWithPaddingForSeqCls(tokenizer, model_args.initial_history, 'max_length', block_size)
    ...
    # Evaluation
    #TODO: verify eval_dataset/ test_dataset/ predictions/ finetuned model used
    if training_args.do_predict:
        ...
        eval_test(best_trial, 'dev', data_args, training_args, eval_dataset, 0, trainer)
        # eval_test(best_trial, 'test', data_args, training_args, eval_dataset, 0, trainer)
